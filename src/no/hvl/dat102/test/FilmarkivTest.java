...
class FilmarkivTest {
	...
	// Filmer
	private Film film0 = new Film(0, "Christopher Nolan", "Interstellar", 2014, Sjanger.ADVENTURE,
			"Warner Bros. Pictures");
	private Film film1 = new Film(1, "David Fincher", "Se7en", 1995, Sjanger.CRIME, "New Line Cinema");
	private Film film2 = new Film(2, "Pete Dicter", "Monsters, Inc.", 2001, Sjanger.ANIMATION, "Pixar");
	private Film film3 = new Film(3, "Quentin Tarantino", "Django Unchained", 2012, Sjanger.DRAMA, "Columbia Pictures");
	private Film film4 = new Film(4, "Denis Villeneuve", "Blade Runner 2049", 2017, Sjanger.ACTION,
			"Warner Bros. Pictures");
	private Film film5 = new Film(5, "Bong Joon Ho", "Parasite", 2019, Sjanger.DRAMA, "Neon");
	private Film film6 = new Film(6, "Martin Scorsese", "The Departed", 2006, Sjanger.DRAMA, "Warner Bros. Pictures");
	private Film film7 = new Film(7, "Damien Chazelle", "La La Land", 2016, Sjanger.DRAMA, "Summit");
	private Film film8 = new Film(8, "David Fincher", "Gone Girl", 2014, Sjanger.DRAMA, "20th Century Fox");
	private Film film9 = new Film(9, "Andrew Stanton", "WALL-E", 2008, Sjanger.ANIMATION, "Pixar");
	...
	public final void soekTittelTest() {
		...
		soekTittelTest[0] = film0;
		soekTittelTest[1] = film3;
		soekTittelTest[2] = film4;
		soekTittelTest[3] = film5;
		soekTittelTest[4] = film6;
		soekTittelTest[5] = film7;
		filmer.leggTilFilm(film0);
		filmer.leggTilFilm(film1);
		filmer.leggTilFilm(film2);
		filmer.leggTilFilm(film3);
